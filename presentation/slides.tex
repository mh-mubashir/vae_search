...
\begin{frame}{Dataset and Implementation}
  \begin{itemize}
    ...
    \item \textbf{Training setup}: Experiments run on the Northeastern Explorer GPU cluster (Nvidia Tesla P100) with a unified training pipeline.
...
\begin{frame}{Visual evaluation - reconstruction and generation ($\beta$-VAE)}
  \centering
  \includegraphics[width=0.45\linewidth]{Figures/Recon Final only All.png}
  \vspace{0.4em}
  \includegraphics[width=0.8\linewidth]{Figures/Final_Generation VAE and b-VAE.png}
  \vspace{0.4em}
  \begin{itemize}
