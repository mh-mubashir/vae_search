...
\begin{frame}{$\beta$-VAE effects}
  ...
  \begin{figure}[h]
    ...
    \begin{minipage}[c]{0.50\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/beta_tradeoff_curve.png}
    \end{minipage}
    \centering
    \begin{minipage}[c]{0.60\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/beta_disentanglement_meter.png}
    \end{minipage}
  \end{figure}
\end{frame}
...
\begin{frame}{VQ-VAE discussion}
  ...
  \begin{figure}[h]
    ...
    \begin{minipage}[c]{0.50\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/vqvae_recon_ssim_bars.png}
    \end{minipage}
    \centering
    \begin{minipage}[c]{0.40\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/vqvae_codebook_usage.png}
    \end{minipage}
  \end{figure}
\end{frame}
  ...
  \end{itemize}
   \begin{figure}[h]
    ...
    \begin{minipage}[c]{0.30\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/accuracy_disentanglement_realism_triangle.png}
    \end{minipage}
  \end{figure}
\end{frame}
